  ...
  let aboutData = [
    {
      ...
      content: (
        <div>
          ...
          <span>Endless Encounters is a text-base <div className='dataTip' data-event='click' clickable='true' data-tip='Role Playing Game'
            data-for='rpg'>RPG</div> developed by EE; John Pendergast, Alexis Felts, Scott Whiteman, and Tiffany Summerford. Once you're in, you can explore in search of ravenous enemies to duel swords with or visit the tavern to discuss rumors.</span>
        </div>
      )
    },
    {
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <span>Combat is turn-based; on your turn, you may click on one of your character's abilities or spells' to perform against your target. Your character will then attempt the action, with the chance to miss, hit, or completely obliterate their enemy. Each hit to your opponent will result in damage to their health. Abilities and Spells have cost, so make sure you have enough (health, mana, and ability) to perform this action. Keep a heads up for
            <div className='dataTip' data-event='click' clickable='true' data-tip='Critical misses happen if your character rolls 1, critical hits on a roll of 20.' data-for='Combat'> Critical </div> misses or hits.</span>
        </div>
      )
    }
  ]
