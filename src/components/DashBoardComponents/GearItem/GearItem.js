  ...
  return (
    <>
      ...
      <div className="flex-1 flex flex-col center rounded-light width-full   m-10px p-1-2">
        <div className="flex-2 border-b width-fit px-1 text-black">{props.slot}</div>
        <h3 className={(props.gear.rarity ? props.gear.rarity : 'common') + " flex-1 font-handy hover-gear font-lg"}
