  ...
  return (
    <div className='char-stat-cont flex-2 rounded-lighter center flex-shrink
     align-self-left border height-fit max-height-40 width-fit text-left p-1-2 m-1' >
      ...
      <img className="flex-1 width-half center mx-2 dance" data-event="click" clickable="true" data-for="char-stats" data-tip={charData} src={require("../../../assets/images/77-774812_open-mage-hat-png.png")} alt="a floppy mage hat" />
      <div id="hp-cont" name="hp-cont" data-event="click" clickable="true" data-tip="Hit Points: 6/8" data-for="char-hp" className="hp-cont mx-1 flex flex-1 flex-row center flex-shrink">
      ...
      <div id="ap-cont" name="ap-cont" data-event="click" clickable="true" data-tip="Action Points: 8/8" data-for="char-ap" className="ap-cont mx-1 flex-shrink flex flex-1 flex-row center">
      ...
      <div id="mana-cont" name="mana-cont" data-event="click" clickable="true" data-tip="Mana Points: 8/8" data-for="char-mp" className="mana-cont mx-1 flex-shrink flex flex-1 flex-row center">
